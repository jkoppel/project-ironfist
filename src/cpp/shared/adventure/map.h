...
enum ADVENTURE_MAP_LOCATION {
  ...
  LOCATION_JAIL = 123,
  TILE_HAS_EVENT = 128,
  LOCATION_RESOURCE_WOOD = 129,
  LOCATION_RESOURCE_MERCURY = 130,
  LOCATION_RESOURCE_ORE = 131,
  LOCATION_RESOURCE_SULFUR = 132,
  LOCATION_RESOURCE_CRYSTAL = 133,
  LOCATION_RESOURCE_GEMS = 134,
  LOCATION_RESOURCE_GOLD = 135,
  LOCATION_MINE_ORE = 136,
  LOCATION_MINE_SULFUR = 137,
  LOCATION_MINE_CRYSTAL = 138,
  LOCATION_MINE_GEMS = 139,
  LOCATION_MINE_GOLD = 140,
  LOCATION_AIR_ALTAR = 141,
  LOCATION_FIRE_ALTAR = 142,
  LOCATION_WATER_ALTAR = 143,
  LOCATION_EARTH_ALTAR = 144,
  LOCATION_BARROW_MOUNDS = 145,
  LOCATION_MAGI_HUT = 146,
  LOCATION_MAGI_EYE = 147,
  LOCATION_STABLES = 148,
  LOCATION_ARENA = 149,
  LOCATION_MERMAIDS = 150,
  LOCATION_SIRENS = 151,
};
