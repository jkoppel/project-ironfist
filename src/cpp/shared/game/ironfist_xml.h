...
public:
  ...
  private:
    ...
    void WriteMapVarTable(tinyxml2::XMLDocument *doc, tinyxml2::XMLNode *dest, std::string id, luaTable *lt);
    void WriteMapVariables(tinyxml2::XMLDocument *doc, tinyxml2::XMLNode *dest);
