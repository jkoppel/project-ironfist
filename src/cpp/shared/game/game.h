...
public:
	...
	char heroesOwned[MAX_TOTAL_HEROES / NUM_PLAYERS];
	char heroesForPurchase[2];
	char relatedToMaxOrNumHeroes;
	int personality;
	char puzzlePieces;
  char _3[44];
	char aiNumberPuzzlePieces;
	char aiProbableUltimateArtifactX;
	char aiProbableUltimateArtifactY;
	char daysLeftWithoutCastle;
	char numCastles;
	char mightBeCurCastleIdx;
	...
	char _4_2_1[6];
	float aiGameAttentionValueBuildings;
	float aiGameAttentionValueCreatures;
	float aiGameAttentionValueHeroes;
	float aiTurnAttentionValueBuildings;
	float aiTurnAttentionValueCreatures;
	float aiTurnAttentionValueHeroes;
	char _4_2_2[28];
	int resourcesIncome[NUM_RESOURCES];
	int aiObeliskValue;
	int aiObeliskRelated;
	int aiUnexploredTerritoryRV;
	float aiIncomeToFightValueRatio;
	float aiMeanGameArtValue;
	float aiGameMapSpare;
