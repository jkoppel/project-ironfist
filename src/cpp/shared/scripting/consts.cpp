...
void set_location_consts(lua_State *L) {
  ...
  lua_setconst(L, "LOCATION_RESOURCE_WOOD", LOCATION_RESOURCE_WOOD);
  lua_setconst(L, "LOCATION_RESOURCE_MERCURY", LOCATION_RESOURCE_MERCURY);
  lua_setconst(L, "LOCATION_RESOURCE_ORE", LOCATION_RESOURCE_ORE);
  lua_setconst(L, "LOCATION_RESOURCE_SULFUR", LOCATION_RESOURCE_SULFUR);
  lua_setconst(L, "LOCATION_RESOURCE_CRYSTAL", LOCATION_RESOURCE_CRYSTAL);
  lua_setconst(L, "LOCATION_RESOURCE_GEMS", LOCATION_RESOURCE_GEMS);
  lua_setconst(L, "LOCATION_RESOURCE_GOLD", LOCATION_RESOURCE_GOLD);
  lua_setconst(L, "LOCATION_MINE_ORE", LOCATION_MINE_ORE);
  lua_setconst(L, "LOCATION_MINE_SULFUR", LOCATION_MINE_SULFUR);
  lua_setconst(L, "LOCATION_MINE_CRYSTAL", LOCATION_MINE_CRYSTAL);
  lua_setconst(L, "LOCATION_MINE_GEMS", LOCATION_MINE_GEMS);
  lua_setconst(L, "LOCATION_MINE_GOLD", LOCATION_MINE_GOLD);
  lua_setconst(L, "LOCATION_AIR_ALTAR", LOCATION_AIR_ALTAR);
  lua_setconst(L, "LOCATION_FIRE_ALTAR", LOCATION_FIRE_ALTAR);
  lua_setconst(L, "LOCATION_WATER_ALTAR", LOCATION_WATER_ALTAR);
  lua_setconst(L, "LOCATION_EARTH_ALTAR", LOCATION_EARTH_ALTAR);
  lua_setconst(L, "LOCATION_BARROW_MOUNDS", LOCATION_BARROW_MOUNDS);
  lua_setconst(L, "LOCATION_MAGI_HUT", LOCATION_MAGI_HUT);
  lua_setconst(L, "LOCATION_MAGI_EYE", LOCATION_MAGI_EYE);
  lua_setconst(L, "LOCATION_STABLES", LOCATION_STABLES);
  lua_setconst(L, "LOCATION_ARENA", LOCATION_ARENA);
  lua_setconst(L, "LOCATION_MERMAIDS", LOCATION_MERMAIDS);
  lua_setconst(L, "LOCATION_SIRENS", LOCATION_SIRENS);
}
