void __thiscall AdvManager::castDimensionDoor(void *this)
{
  int v1; // [sp+Ch] [bp-24h]@1
  GUIWindow *thisa; // [sp+18h] [bp-18h]@1
  int row; // [sp+1Ch] [bp-14h]@7
  MapTile *v4; // [sp+20h] [bp-10h]@7
  ...
  if ( HeroWindowManager::instance->buttonPressedCode == 1 )
  {
    ...
    v4 = AdvManager::getTile(
           (AdvManager *)v1,
           *(_DWORD *)(v1 + 470) + *(_DWORD *)(v1 + 486),
           *(_DWORD *)(v1 + 474) + *(_DWORD *)(v1 + 490));
    if ( (!(*(_BYTE *)(v6 + 227) & 0x80) || !tileToTerrainType[v4->tileType])
      && (*(_BYTE *)(v6 + 227) & 0x80 || tileToTerrainType[v4->tileType]) )
    {
      SoundManager::playCDTrack(soundManager, 1);
      sub_453A20((void *)v1, v6, __PAIR__(row, col), 0, 0);
      SoundManager::playCDTrack(soundManager, (unsigned __int8)terrainTrackNumbers[*(_DWORD *)(v1 + 166)]);
    }
    else
    {
