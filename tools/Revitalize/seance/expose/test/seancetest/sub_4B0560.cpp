int __stdcall sub_4B0560(int a1, int a2, int a3, int a4, int a5)
{
  double v5; // st7@21
  double v6; // st7@21
  ...
  v18 = a4 * (unsigned __int64)sub_4B13F0((int)&costs);
  v22 = (signed __int64)((double)(a4 * creature_table[a2].fight_value) * *(float *)&curPlayer->_4[100]);
  if ( *(_BYTE *)(a1 + 23) != -1 )
  {
    v11 = (char *)&gameObject->heroes[*(_BYTE *)(a1 + 23)];
    v22 = (signed __int64)((double)v22 * 1.1);
    if ( creature_table[a2].faction == (unsigned __int8)v11[23] )
      v22 = (signed __int64)((double)v22 * 1.1);
    if ( creature_table[a2].creature_flags & 4 )
    {
      for ( i = 0; i < 5; ++i )
      {
        if ( v11[i + 101] != -1 )
        {
          if ( creature_table[v11[i + 101]].creature_flags & 4 )
            ++v12;
        }
      }
      v22 = (signed __int64)((1.18 - (double)v12 * 0.06) * (double)v22);
    }
    v22 = (signed __int64)((*(float *)&gameObject->players[*(_BYTE *)(a1 + 1)]._4[24] + 0.66) * (double)v22);
  }
  if ( creature_table[a2].creature_flags & 4 )
  {
    for ( j = 0; j < 5; ++j )
    {
      if ( *(_BYTE *)(j + a1 + 8) != -1 && creature_table[*(_BYTE *)(j + a1 + 8)].creature_flags & 4 )
        ++v12;
    }
    v22 = (signed __int64)((1.18 - (double)v12 * 0.06) * (double)v22);
  }
  sub_4B1110(a1, 0, (int)&v19, (int)&v17, (int)&v16, (int)&v14, (int)&v13, (int)&v21);
  v5 = v21 + 0.96;
  v15 = v5;
  v22 = (signed __int64)(v5 * v15 * v15 * (double)v22);
  v6 = sub_4B2A50((int)&costs);
