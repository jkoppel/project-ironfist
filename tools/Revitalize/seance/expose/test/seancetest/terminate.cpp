// This actually does return if terminateUnexpectedly lock is set,
// ;but that means another thread is shutting down, so
// ;it's better to treat this like a noreturn function.
void __thiscall terminate(char *this)
{
