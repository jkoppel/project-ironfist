signed int __thiscall CombatManager::findBestDistanceHPTradeoffStack(CombatManager *this, CreatureStack *stack, int side, int stackBmask)
{
  int dist; // eax@4
  int hp; // edx@4
