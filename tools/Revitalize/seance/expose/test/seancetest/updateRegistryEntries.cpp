void __cdecl updateRegistryEntries()
{
  ...
  {
    RegSetValueExA(hKey, "Music Volume", 0, REG_DWORD, &musicVolume, 4u);
    RegSetValueExA(hKey, "Sound Volume", 0, REG_DWORD, &soundVolume, 4u);
    RegSetValueExA(hKey, "Walk Speed", 0, REG_DWORD, &walkSpeed, 4u);
    RegSetValueExA(hKey, "Computer Walk Speed", 0, REG_DWORD, &computerWalkSpeed, 4u);
    ...
    RegSetValueExA(hKey, "Main Game Show Menu", REG_NONE, 4u, (const BYTE *)&mainWindows, 4u);
    RegSetValueExA(hKey, "Main Game X", 0, REG_DWORD, (const BYTE *)&mainWindows + 4, 4u);
    RegSetValueExA(hKey, "Main Game Y", 0, REG_DWORD, (const BYTE *)&mainWindows + 8, 4u);
    RegSetValueExA(hKey, "Main Game Width", 0, REG_DWORD, (const BYTE *)&mainWindows + 12, 4u);
    RegSetValueExA(hKey, "Main Game Height", 0, REG_DWORD, (const BYTE *)&mainWindows + 16, 4u);
    RegSetValueExA(hKey, "Main Game Full Screen", 0, REG_DWORD, (const BYTE *)&mainWindows + 20, 4u);
    RegSetValueExA(hKey, "Main Game Color Mouse Cursor", 0, REG_DWORD, (const BYTE *)&mainWindows + 24, 4u);
    RegSetValueExA(hKey, "Editor Show Menu", 0, REG_DWORD, (const BYTE *)&mainWindows + 28, 4u);
    RegSetValueExA(hKey, "Editor X", 0, REG_DWORD, (const BYTE *)&mainWindows + 32, 4u);
    RegSetValueExA(hKey, "Editor Y", 0, REG_DWORD, (const BYTE *)&mainWindows + 36, 4u);
    RegSetValueExA(hKey, "Editor Width", 0, REG_DWORD, (const BYTE *)&mainWindows + 40, 4u);
    RegSetValueExA(hKey, "Editor Height", 0, REG_DWORD, (const BYTE *)&mainWindows + 44, 4u);
    RegSetValueExA(hKey, "Editor Full Screen", 0, REG_DWORD, (const BYTE *)&mainWindows + 48, 4u);
    RegSetValueExA(hKey, "Editor Color Mouse Cursor", 0, REG_DWORD, (const BYTE *)&mainWindows + 52, 4u);
    RegCloseKey(hKey);
  }
}
