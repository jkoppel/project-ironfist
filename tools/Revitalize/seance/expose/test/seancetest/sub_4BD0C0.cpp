__int16 __fastcall sub_4BD0C0(__int16 a1, unsigned __int16 a2, LPVOID lpBuffer)
{
  ...
  if ( !ClearCommError((HANDLE)dword_532CF0[24 * a1], &Errors, &Stat) )
    sub_4BC8B0("Clear communications error queue");
  ...
  if ( nNumberOfBytesToRead )
  {
    if ( !ReadFile((HANDLE)dword_532CF0[24 * v5], lpBuffer, nNumberOfBytesToRead, &NumberOfBytesRead, 0) )
      sub_4BC8B0("Read communications data");
