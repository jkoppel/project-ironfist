void __thiscall sub_4BED90(int this)
{
  signed int v1; // eax@8
  char v2; // al@8
  ...
  Hero::alterPrimarySkillsForArtifact(*(Hero **)(this + 4 * *(_DWORD *)(this + 70) + 62), a2, 1);
  Hero::alterPrimarySkillsForArtifact(*(Hero **)(v3 + 4 * *(_DWORD *)(v3 + 74) + 62), v12, 1);
  ...
  *(_BYTE *)(*(_DWORD *)(v3 + 4 * *(_DWORD *)(v3 + 74) + 62) + *(_DWORD *)(v3 + 82) + 236) = v11;
  Hero::alterPrimarySkillsForArtifact(*(Hero **)(v3 + 4 * *(_DWORD *)(v3 + 70) + 62), v12, 0);
  Hero::alterPrimarySkillsForArtifact(*(Hero **)(v3 + 4 * *(_DWORD *)(v3 + 74) + 62), a2, 0);
  Hero::checkForFullBattleGarb(*(Hero **)(v3 + 4 * *(_DWORD *)(v3 + 70) + 62), 1);
  Hero::checkForFullBattleGarb(*(Hero **)(v3 + 4 * *(_DWORD *)(v3 + 74) + 62), 1);
  if ( a2 == 102 || v12 == 102 )
  {
    evt = 512;
    for ( i = 0; i < 2; ++i )
    {
      for ( j = 0; j < 8; ++j )
      {
        if ( *(_DWORD *)(*(_DWORD *)(v3 + 4 * i + 62) + 144) > j )
        {
          ...
          v6 = j + 8 * i + 216;
          v7 = globBuf;
          v1 = sub_498B10(*(Hero **)(v3 + 4 * i + 62), j);
          v2 = Hero::getSecondarySkillLevelWithBonii(*(Hero **)(v3 + 4 * i + 62), (SECONDARY_SKILL)v1);
