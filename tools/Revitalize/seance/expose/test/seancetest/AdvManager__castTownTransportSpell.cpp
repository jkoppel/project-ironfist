void __thiscall AdvManager::castTownTransportSpell(void *this, int a2)
{
  int v2; // ebx@16
...
LABEL_19:
    if ( gameObject->castles[curPlayer->castlesOwned[v12]].visitingHeroIdx == -1 )
    {
      ...
      *(_WORD *)(v14 + 47) = curPlayer->castlesOwned[v12];
      SoundManager::playCDTrack(soundManager, (unsigned __int8)terrainTrackNumbers[*(_DWORD *)((char *)v4 + 166)]);
    }
    else
    {
