void __thiscall ArmyInfo::randomlyKillCreatures(ArmyInfo *this, float chance)
{
  ArmyInfo *thisa; // [sp+Ch] [bp-18h]@1
  ...
  for ( i = 0; i < 5; ++i )
  {
    ...
    else
    {
      ...
      {
        if ( nextRandomInt(0, 100) < (signed int)(signed __int64)(chance * 100.0) )
          ++numKilled;
      }
