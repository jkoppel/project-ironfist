void __thiscall sub_4D9D50(int this, int a2)
{
  __int16 v2; // dx@1
  int v3; // ebx@1
  int v4; // ecx@1
  ...
  if ( v4 > a2 )
  {
    ...
    if ( v2 == 1 )
    {
      KBFree(**(void ***)(v3 + 60), (int)"F:\\h2xsrc\\Base\\listbox.cpp", 156);
      KBFree(*(void **)(v3 + 60), (int)"F:\\h2xsrc\\Base\\listbox.cpp", 157);
      *(_DWORD *)(v3 + 60) = 0;
    }
    else
    {
      v11 = KBAlloc(4 * v4 - 4, "F:\\h2xsrc\\Base\\listbox.cpp", 162);
      ...
      v8 = *(void **)(v3 + 60);
      if ( v8 )
        KBFree(v8, (int)"F:\\h2xsrc\\Base\\listbox.cpp", 169);
      *(_DWORD *)(v3 + 60) = v11;
    }
    v9 = *(_WORD *)(v3 + 50) - 1;
    v10 = *(_WORD *)(v3 + 66) == 0;
