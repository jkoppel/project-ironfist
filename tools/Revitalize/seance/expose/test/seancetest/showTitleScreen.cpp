int __cdecl showTitleScreen()
{
  signed int v1; // eax@156
  int v2; // eax@175
  const char *v3; // ST1C_4@201
  int v4; // ebx@201
  __int16 v5; // ax@201
  int v6; // [sp-4h] [bp-174h]@5
  GUIWindow *this; // [sp+24h] [bp-14Ch]@55
  signed int v8; // [sp+28h] [bp-148h]@187
  bool v9; // [sp+28h] [bp-148h]@200
  char v10; // [sp+2Ch] [bp-144h]@125
  char v11; // [sp+32h] [bp-13Eh]@134
  char v12; // [sp+33h] [bp-13Dh]@134
  char v13; // [sp+34h] [bp-13Ch]@125
  char v14[8]; // [sp+12Ch] [bp-44h]@95
  int j; // [sp+134h] [bp-3Ch]@95
  int k; // [sp+138h] [bp-38h]@99
  char v17[8]; // [sp+13Ch] [bp-34h]@95
  int v18; // [sp+144h] [bp-2Ch]@71
  int v19; // [sp+148h] [bp-28h]@11
  int v20; // [sp+154h] [bp-1Ch]@14
  int i; // [sp+158h] [bp-18h]@65
  int v22; // [sp+15Ch] [bp-14h]@136
  int v23; // [sp+164h] [bp-Ch]@3
  ...
  if ( dword_52409C )
  {
    ...
    if ( !dword_4F7468 )
    {
      v19 = HeroWindowManager::instance->field_56;
      HeroWindowManager::instance->field_56 = 0;
      if ( sub_45A2A0(66) )
        sub_45A2A0(1);
      sub_45A2A0(65);
      HeroWindowManager::instance->field_56 = v19;
    }
  }
  sub_437670();
...
LABEL_16:
          ...
          if ( dword_523408 != 105 )
            SoundManager::playCDTrack(soundManager, 42);
          if ( !v20 )
          {
            if ( dword_523408 != 105 )
            {
          ...
          if ( dword_52340C == -1 || !dword_524BE0 )
          {
            ...
            if ( dword_523408 == -1 )
            {
              ...
              dword_4F4BC8 = 0;
              v23 = HeroWindowManager::instance->buttonPressedCode;
              dword_4F307C = 0;
            }
            else
            {
...
LABEL_51:
            ...
            if ( !v25 )
            {
              ...
              if ( dword_4F7494 && !dword_523F14 )
              {
                ...
                for ( j = 0; j < 6; ++j )
                {
                  if ( dword_524810[j] )
                  {
                    for ( k = 0; k < 6; ++k )
                    {
                      if ( strlen((int)&gameObject->_10[4 * k]) == 3
                        && !strcmp((int)&gameObject->_10[4 * k], (int)((char *)&dword_526CE0 + 34 * j))
                ...
                memcpy(&v10, &byte_5247A0, 6u);
                memcpy(&v13, &dword_526CE0, 0xCCu);
                ...
                {
                  v22 = sub_46E1D0(&v10, i, 0xD4u, 32, 1, 1, -1);
                  if ( !v22 )
                    terminate(0);
                }
                for ( i = 1; i < dword_5235D4; ++i )
              ...
              if ( dword_4F7494 && dword_523F08 )
              {
                ...
                if ( !dword_523018 )
                  terminate(0);
                GameInfo::loadGame(gameObject, (const char *)&computerWalkSpeed + 327, 0, 1);
              ...
              while ( 1 )
              {
                ...
                else
                {
                  if ( !byte_5304A0 )
                  {
                    ...
                    if ( dword_4F74A4 )
                    {
                      SoundManager::otherPlayTrack(soundManager, 43, 0, -1, v6);
                    }
                    else
                    {
                      sub_4C7C60(HeroWindowManager::instance, 1, 8, dword_524234);
                      ...
                      HeroWindowManager::instance->field_56 = 1;
                      v20 = 1;
                      SoundManager::otherPlayTrack(soundManager, 42, 0, -1, v6);
                    }
                    goto LABEL_211;
                  }
                  v9 = sub_471A60((int)&unk_530450);
                  if ( sub_4723E0((int)&unk_530450) )
                  {
                    dword_4F74A4 = 1;
                    winScenario((void *)2);
                    v3 = (&off_51A880)[4 * sub_4728C0(&unk_530450)];
                    v4 = (signed __int16)sub_472850((int)&unk_530450);
                    v5 = sub_472850((int)&unk_530450);
                    sub_435860(v5, v4, 0, 2, v3);
                  }
                  if ( !v9 )
                    goto LABEL_211;
                  for ( i = 0; i < 6; ++i )
...
LABEL_150:
                ...
                if ( dword_5235D4 > 1 )
                {
                  for ( i = 0; i < dword_5235D4; ++i )
                  {
                    if ( dword_524778 != 2 )
                    {
                      v1 = sub_435DC0((void *)i);
                      strcpy((int)&dword_5235E0[21 * v1]);
                    }
                  }
                }
                for ( i = 0; gameObject->numPlayers > i; ++i )
                {
                  if ( !strlen((int)&dword_5235E0[21 * i]) )
                  {
                ...
                else
                {
                  if ( !byte_5304A0 || !sub_472440((int)&unk_530450) )
                  {
                    ...
                    if ( v23 == 101 )
                    {
                      v2 = sub_418CE0(gameObject->players, 0);
                      sub_450C10(advManager, v2, 0);
                    }
                    if ( v23 == 101 || dword_50CD48 )
                    {
                      dword_50CD48 = 0;
