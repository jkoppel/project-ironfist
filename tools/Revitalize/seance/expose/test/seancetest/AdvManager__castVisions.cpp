signed int __thiscall AdvManager::castVisions(void *this, int a2)
{
  int v2; // ebx@6
  ...
  for ( col = *(_DWORD *)(a2 + 25) - 3; *(_DWORD *)(a2 + 25) + 3 >= col; ++col )
  {
    ...
    {
      v10 = AdvManager::getTile((AdvManager *)v4, col, row);
      if ( v10->objType == 152 )
      {
  ...
  v10 = AdvManager::getTile((AdvManager *)v4, v15, v18);
