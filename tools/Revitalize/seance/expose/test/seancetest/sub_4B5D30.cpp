int __stdcall sub_4B5D30(int a1, int a2, int a3)
{
  int result; // eax@2
  __int16 v4; // ax@66
  ...
  else
  {
    ...
    for ( i = 0; i < 5; ++i )
    {
      *((_BYTE *)dword_5247BC + i) = v19;
      *(_WORD *)((char *)dword_5247BC + 2 * i + 5) = v20;
    }
    v5 = 0;
    switch ( v11 )
    {
      case 12:
        switch ( (unsigned __int8)((unsigned __int8)(*(_WORD *)(a2 + 4) >> 8) >> -5) )
        {
          ...
          case 4u:
            ...
            break;
          case 5u:
            v5 = (signed __int64)(flt_530730 * 1000.0 + *(float *)&curPlayer->_4[104]);
            break;
          default:
            goto LABEL_37;
        }
      ...
      case 32:
        switch ( (unsigned __int8)((unsigned __int8)(*(_WORD *)(a2 + 4) >> 8) >> -5) )
        {
          ...
          case 4u:
            ...
            break;
          case 5u:
            v5 = (signed __int64)(flt_530730 * 2000.0 + *(float *)&curPlayer->_4[104]);
            break;
          default:
            goto LABEL_37;
        }
...
LABEL_37:
    sub_4B5140(a1 + 101, a1, (unsigned int)dword_5247BC, 0, 0, v5, (int)&v16, (int)&v6);
    if ( a3 )
    {
      result = v6;
    }
    else
    {
      if ( v16 )
      {
        v26 = sub_4B38C0(a1 + 101, a1, (unsigned int)dword_5247BC, 0, 0, (float *)v21, (float *)&v18);
        if ( v26 )
        {
          switch ( v11 )
          {
            case 12:
              ...
              {
                case 2u:
                  grantResource((Hero *)a1, 6, 500);
                  break;
                case 3u:
                  grantResource((Hero *)a1, 6, 1000);
                  break;
                case 4u:
                  grantResource((Hero *)a1, 6, 3000);
                  break;
                case 5u:
                  grantResource((Hero *)a1, 6, 1000);
                  Hero::acquireRandomArtifact((Hero *)a1);
                  break;
                default:
                  goto LABEL_66;
              }
            ...
            case 32:
              switch ( (unsigned __int8)((unsigned __int8)(*(_WORD *)(a2 + 4) >> 8) >> -5) )
              {
                case 2u:
                  ...
                  break;
                case 3u:
                  grantResource((Hero *)a1, 6, 2000);
                  break;
                case 4u:
                  grantResource((Hero *)a1, 6, 5000);
                  break;
                case 5u:
                  grantResource((Hero *)a1, 6, 2000);
                  Hero::acquireRandomArtifact((Hero *)a1);
