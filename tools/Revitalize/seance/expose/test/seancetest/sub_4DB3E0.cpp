void __thiscall sub_4DB3E0(int this)
{
  int v1; // ebx@1
  ...
  InputEvent a2; // [sp+24h] [bp-38h]@11
  ...
  *(_WORD *)(v1 + 128) = v15;
  ...
  HeroWindowManager::redrawRectangle(
    ...
    *(_WORD *)(v1 + 104),
    *(_WORD *)(v1 + 106));
  v24 = (Bitmap *)operator new(0x1Au);
  if ( v24 )
    *(_DWORD *)(v1 + 176) = Bitmap_constructor(v24, 0, *(_WORD *)(v1 + 126), *(_WORD *)(v1 + 128));
  else
    *(_DWORD *)(v1 + 176) = 0;
  Bitmap::getContentsFromScreen(*(Bitmap **)(v1 + 176), *(_WORD *)(v1 + 122), *(_WORD *)(v1 + 124));
LABEL_20:
  sub_4DB060(v1);
  while ( 2 )
  {
    ...
    passOnMessages();
    memcpy(&v68, InputManager::nextInputEvent(inputManager, &a2), 0x1Cu);
    (*(void (__stdcall **)(int *))(LODWORD(mouseManager->vtable) + 8))(&v68);
    v25 = *(_DWORD *)(v1 + 4);
    v26 = *(_DWORD *)(v25 + 40);
    v27 = *(_DWORD *)(v25 + 44);
    v28 = v70 - v26;
...
LABEL_95:
        Bitmap::drawToScreenBuffer(*(Bitmap **)(v1 + 176), *(_WORD *)(v1 + 122), *(_WORD *)(v1 + 124));
        HeroWindowManager::redrawRectangle(
          HeroWindowManager::instance,
          *(_WORD *)(v1 + 122),
          *(_WORD *)(v1 + 124),
