char __fastcall rasterizeWithSubstitutionMirrored(Icon *icn, Bitmap *bmp, int offX, int offY, int idx, signed int a6, int a7, int a8, int a9, int a10, int a11, char *paletteSubstitution)
{
