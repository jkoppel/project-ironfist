void __thiscall sub_4DA220(ListBox *this, int a2)
{
  GUIWindow *v2; // eax@1
  ListBox *thisa; // esi@1
  int v4; // edi@1
  ...
  for ( i = 0; thisa->field_28 > i; ++i )
  {
    if ( i )
    {
      ...
      {
        Icon::drawToScreen(thisa->icon, v4, v5, thisa->field_44[2], 0);
        if ( thisa->field_2A > i )
        {
      ...
      Icon::drawToScreen(thisa->icon, v4, v5, thisa->field_44[1], 0);
      if ( thisa->field_2A > i )
      {
    ...
    {
      Icon::drawToScreen(thisa->icon, v4, v5, thisa->field_44[0], 0);
      if ( thisa->field_2A > 0 )
      {
  ...
  Icon::drawToScreen(thisa->icon, (signed __int16)v17, (signed __int16)v22, v21, 0);
  if ( a2 )
