int __fastcall rasterizeWithSubstitution(Icon *a1, Bitmap *buf, int a3, int a4, int a5, signed int a6, int a7, int a8, unsigned int a9, int a10, int a11, char *paletteSubstitution, int a13)
{
  ICNHeader *v13; // esi@1
  int v14; // ecx@1
  int v15; // edi@1
