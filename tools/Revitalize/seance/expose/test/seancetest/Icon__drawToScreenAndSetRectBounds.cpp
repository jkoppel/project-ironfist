signed int __thiscall Icon::drawToScreenAndSetRectBounds(Icon *this, int offsetX, int offsetY, int imageIdx, H2RECT *rect, int mirrored, int a11, char *paletteSubstitution, int a12)
{
  int idx; // edx@2
