int __thiscall sub_4B03D0(void *this, int a2, int a3, int a4)
{
  double v4; // st7@9
  double v5; // ST18_8@12
  double v6; // ST10_8@12
  ...
  for ( building = 0; building < 32; ++building )
  {
    if ( (!((1 << building) & *(_DWORD *)(a2 + 24)) || !building && (signed int)*(_BYTE *)(a2 + 28) < 5)
      && sub_4323C0((unsigned int *)a2, building) )
    {
      sub_4AFBB0(
        a2,
        building,
        ...
        building,
        v19);
      if ( curPlayer->personality == 1 )
      {
        v13 = v15;
        v15 = (signed __int64)((double)v15 * 1.3);
      }
      v12 = unseededNextRand(1, 5) + 95;
      ...
      *(float *)&v16 = v4;
      ...
      if ( debugLogLevel >= 5 )
      {
        v5 = *(float *)&v16;
        v6 = *(float *)&v19;
        v7 = buildingName(*(_BYTE *)(a2 + 3), building);
        sprintf(
          globBuf,
