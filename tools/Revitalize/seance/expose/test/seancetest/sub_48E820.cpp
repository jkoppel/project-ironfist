int __thiscall sub_48E820(AdvManager *this, int a2, int a3, signed int a4, int a5, __int64 a6, int a7, __int64 a8, char a9, signed int a10, int a11, char a12, signed int a13, int a14)
{
