void __thiscall GUIWindow::insertElement(GUIWindow *this, AbstractGUIComponent *guiObj, int index)
{
  GUIWindow *thisa; // [sp+Ch] [bp-8h]@1
  AbstractGUIComponent *component; // [sp+10h] [bp-4h]@1
  ...
  if ( !AbstractGUIComponent::setParent(guiObj, index, this) )
  {
