int __fastcall sub_49B830(int a1, int a2, int a3)
{
  ...
  errorCode = ((int (__cdecl *)(LPDIRECTDRAW *, int *, int *, _DWORD))(*directDrawObject)[6].lpVtbl)(
                directDrawObject,
                &v8,
                &v6,
                0);
  if ( errorCode )
    fatalDirectDrawError((MACRO_DDERR)errorCode, "F:\\h2xsrc\\Source\\wingraph.cpp", word_519998 + 28);
  if ( !a3 )
  {
    errorCode = (*(int (__cdecl **)(int, _DWORD, int *, signed int, _DWORD))(*(_DWORD *)v6 + 100))(v6, 0, &v8, 1, 0);
    if ( errorCode )
      fatalDirectDrawError((MACRO_DDERR)errorCode, "F:\\h2xsrc\\Source\\wingraph.cpp", word_519998 + 36);
    if ( HeroWindowManager::instance->screenBuffer )
    {
      HeroWindowManager::instance->screenBuffer->contents = v12;
      screenContents = (Bitmap *)v12;
    }
    else
    {
      screenContents = (Bitmap *)v12;
