void __thiscall sub_48F940(int this, int a2, int a3, __int64 a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12, int a13, int a14, int a15, int a16, int a17, int a18, int a19, int a20, int a21, int a22, int a23, int a24, int a25, int a26, int a27, int a28, int a29, int a30, int a31, int a32, int a33, void *a34, int a35, int a36)
{
  __int16 v36; // ax@26
  __int16 v37; // ax@27
  __int16 v38; // ax@53
