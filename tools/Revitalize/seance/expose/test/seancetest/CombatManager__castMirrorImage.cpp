    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( i )
      {
        ...
        if ( creat->facingRight == 1 )
          v8 = creat->occupiedHex + 1;
        else
          v8 = creat->occupiedHex - 1;
      }
      else
      {
        v8 = creat->occupiedHex;
      }
      for ( j = 0; j < 6; ++j )
      {
        if ( creat->facingRight == 1 )
          ...
          neighborIdx = 5 - j;
        if ( (creat->facingRight != 1 || neighborIdx != 1 || i || v17 != 1)
          && (creat->facingRight != 1 || neighborIdx != 4 || i || v17 != 1)
          && (creat->facingRight != 1 || neighborIdx != 4 || i != 1 || v17 > 2)
          && (creat->facingRight || neighborIdx != 4 || i || v17 != 1)
          && (creat->facingRight || neighborIdx != 1 || i || v17 != 1)
          && (creat->facingRight || neighborIdx != 1 || i != 1 || v17 > 2) )
        {
          imageHex = v8;
          for ( k = 0; k < v17; ++k )
          {
              ...
              && CreatureStack::canPlaceCreature(creat, imageHex, 0, 0) )
            {
              ...
              *(_DWORD *)&imageStack->creature.creature_flags |= 0x800u;
              ...
              tick = (signed __int64)((double)getTickCount() + combatSpeedPercentages[*(_DWORD *)&combatSpeed] * 50.0);
              for ( l = 0; l < 16; ++l )
              {
