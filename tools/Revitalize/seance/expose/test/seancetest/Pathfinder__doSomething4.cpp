char __thiscall Pathfinder::doSomething4(Pathfinder *this, int a2, int a3, int a4, signed int a5, signed int a6, char a7, int a8, char a9, char a10, int a11, char a12, char a13)
{
  int v13; // eax@1
