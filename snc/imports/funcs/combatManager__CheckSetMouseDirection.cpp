    ...
    if ( thisa->_15[v11 + 36] != *(_DWORD *)&thisa->_15[60] )
    {
      *(_DWORD *)&thisa->_15[60] = thisa->_15[v11 + 36];
      ...
      if ( v13 != 6 && v13 != 7 )
      {
        ...
        else if ( !thisa->creatures[thisa->otherCurrentSideThing][thisa->someSortOfStackIdx].facingRight
  && thisa->creatures[thisa->otherCurrentSideThing][thisa->someSortOfStackIdx].creature.creature_flags & 1
  && (!v13 || v13 == 1 || v13 == 2) )
        {
          ++a4;
      ...
      else if ( thisa->creatures[thisa->otherCurrentSideThing][thisa->someSortOfStackIdx].creature.creature_flags & 1 )
      {
