{
  ...
  while ( v13 > 0 )
  {
    ...
    if ( v9 != -1 )
    {
      ...
      {
        v4 = v9;
        v5 = (char *)&sMapChangeQueue + 11 * v9;
        LOBYTE(v4) = v5[10];
        v4 <<= 16;
        LOWORD(v4) = *((_WORD *)v5 + 4);
        advManager::ProcessMapChange(v8, *(_DWORD *)v5, *((_DWORD *)v5 + 1), v4);
      }
      result = 5 * v9;
      *((_BYTE *)&sMapChangeQueue + 11 * v9) = 0;
      ++v10;
    }
  }
  v15 = 1;
    ...
    for ( j = 0; j < 196; ++j )
    {
      ...
      if ( *((_BYTE *)&sMapChangeQueue + 11 * j) )
      {
        ...
        if ( *(int *)((char *)&dword_523667 + 11 * j) == *(_DWORD *)&giMapChangeCtr )
        {
          ...
          {
            v6 = j;
            v7 = (char *)&sMapChangeQueue + 11 * j;
            LOBYTE(v6) = v7[10];
            v6 <<= 16;
            LOWORD(v6) = *((_WORD *)v7 + 4);
            advManager::ProcessMapChange(v8, *(_DWORD *)v7, *((_DWORD *)v7 + 1), v6);
          }
          result = 5 * j;
