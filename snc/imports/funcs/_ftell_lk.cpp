{
  ...
  if ( v4 & 3 )
  {
    if ( *(_BYTE *)(*(int *)((char *)__pioinfo + ((v13 & 0xFFFFFFE7) >> 3)) + 36 * (v13 & 0x1F) + 4) & 0x80 && v6 < v5 )
    {
      do
      {
        if ( *(_BYTE *)v6 == 10 )
  ...
  if ( v4 & 1 )
  {
    ...
    v8 = v7 + v14;
    v9 = 36 * (v13 & 0x1F);
    if ( *(_BYTE *)(*(int *)((char *)__pioinfo + ((v13 & 0xFFFFFFE7) >> 3)) + v9 + 4) & 0x80 )
    {
      if ( _lseek(v13, 0, 2u) == v2 )
      {
        v10 = *(_DWORD *)(a1 + 8);
      ...
      else
      {
        ...
        if ( (unsigned int)v8 > 0x200 || (v12 = *(_DWORD *)(a1 + 12), !(v12 & 8)) || (v8 = 512, BYTE1(v12) & 4) )
          v8 = *(_DWORD *)(a1 + 24);
        if ( !(*(_BYTE *)(*(int *)((char *)__pioinfo + ((v13 & 0xFFFFFFE7) >> 3)) + v9 + 4) & 4) )
          goto LABEL_34;
      }
      ++v8;
    }
