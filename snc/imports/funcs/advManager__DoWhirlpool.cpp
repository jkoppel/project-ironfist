  ...
  if ( gbHumanPlayer[result] )
  {
    ...
    if ( result == 1 )
    {
      ...
      for ( i = 0; i < 5; ++i )
      {
        ...
        {
          if ( v2 > *(_WORD *)(a1 + 2 * i + 106) * gMonsterDatabase[*(_BYTE *)(i + a1 + 101)].fight_value )
          {
            v2 = *(_WORD *)(a1 + 2 * i + 106) * gMonsterDatabase[*(_BYTE *)(i + a1 + 101)].fight_value;
            v4 = i;
          }
        }
      }
      if ( armyGroup::GetNumArmies((armyGroup *)(a1 + 101)) <= 1 )
      {
