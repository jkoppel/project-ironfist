{
    ...
    *(_WORD *)a5 = 1;
    if ( HIDWORD(a1) == -2147483648 && !(_DWORD)a1 || BYTE7(a1) & 0x40 )
    {
      if ( a2 & 0x8000 && a1 == -4611686018427387904i64 )
      {
        ...
        v25 = 0;
        *(_DWORD *)v8 = _string_;
        *(_WORD *)(v8 + 4) = *((_WORD *)&_string_ + 2);
        *(_BYTE *)(a5 + 3) = 5;
      }
      else if ( HIDWORD(a1) != -2147483648 || (_DWORD)a1 )
      {
        v10 = a5 + 4;
        v25 = 0;
        *(_DWORD *)v10 = _string_;
        *(_WORD *)(v10 + 4) = *((_WORD *)&_string_ + 2);
        *(_BYTE *)(v10 + 6) = *((_BYTE *)&_string_ + 6);
        *(_BYTE *)(a5 + 3) = 6;
      }
      else
      {
    ...
    else
    {
      ...
      v25 = 0;
      *(_DWORD *)v7 = _string_;
      *(_WORD *)(v7 + 4) = *((_WORD *)&_string_ + 2);
      *(_BYTE *)(v7 + 6) = *((_BYTE *)&_string_ + 6);
      *(_BYTE *)(a5 + 3) = 6;
    }
    return v25;
  }
  ...
  *(_QWORD *)&v23[2] = a1;
  *(_WORD *)v23 = 0;
  __multtenpow12((int)v23, -(signed __int16)v11, 1);
  if ( v24 >= 0x3FFFu )
  {
    LOWORD(v11) = v11 + 1;
    __ld12mul((int)v23, (int)&v26);
  }
  *(_WORD *)a5 = v11;
  if ( a4 & 1 )
  {
