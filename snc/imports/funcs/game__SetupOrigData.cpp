{
  ...
  *(_WORD *)v2 = 1;
  giMonthType = 0;
  *(_DWORD *)&giMonthTypeExtra = 0;
  *(_DWORD *)&giWeekType = 0;
  *(_DWORD *)&giWeekTypeExtra = 0;
  *((_BYTE *)v2 + 25501) = 0;
  ...
  *((_WORD *)v2 + 587) = *((_WORD *)v2 + 588);
  ...
  for ( i = 0; i < 6; ++i )
  {
    ...
    *((_BYTE *)v2 + 283 * i + 1199) = 0;
    memset((char *)v2 + 283 * i + 1192, 0xFFu, 2u);
    memset((char *)v2 + 283 * i + 1184, 0xFFu, 8u);
    memset((char *)v2 + 283 * i + 1251, 0xFFu, 0x48u);
  }
  *((_BYTE *)v2 + 2898) = 0;
  gpAdvManager->field_2A6 = 0;
  memset((char *)v2 + 23680, 0xFFu, 0x36u);
  for ( j = 0; j < 54; ++j )
  {
    memset((char *)v2 + 250 * j + 10180, 0, 0xFAu);
    memset((char *)v2 + 250 * j + 10328, 0, 0x41u);
    memset((char *)v2 + 250 * j + 10393, 0xFFu, 0xEu);
    ...
    *((_BYTE *)v2 + 250 * j + 10224) = 2;
    strcpy((char *)v2 + 250 * j + 10190, (&gHeroDefaultNames)[4 * j]);
    *((_BYTE *)v2 + 250 * j + 10203) = j / 9;
    for ( k = 0; k < 5; ++k )
      *((_BYTE *)v2 + 250 * j + k + 10243) = *(&gStartingHeroStats[*((_BYTE *)v2 + 250 * j + 10203)].attack + k);
    for ( l = 0; l < 5; ++l )
    ...
    *((_WORD *)v2 + 125 * j + 5090) = 10 * hero::Stats((hero *)((char *)v2 + 250 * j + 10180), PRIMARY_SKILL_KNOWLEDGE);
    *(_DWORD *)((char *)v2 + 250 * j + 10324) = 0;
    ...
    {
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 6, 1);
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 10, 1);
    }
    if ( *((_BYTE *)v2 + 250 * j + 10203) == 2 )
    {
      *((_BYTE *)v2 + 250 * j + 10393) = 81;
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 5, 2);
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 7, 1);
    }
    if ( *((_BYTE *)v2 + 250 * j + 10203) == 1 )
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 0, 2);
    if ( *((_BYTE *)v2 + 250 * j + 10203) == 3 )
    {
      *((_BYTE *)v2 + 250 * j + 10393) = 81;
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 3, 2);
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 7, 1);
    }
    if ( *((_BYTE *)v2 + 250 * j + 10203) == 4 )
    {
      *((_BYTE *)v2 + 250 * j + 10393) = 81;
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 7, 2);
    }
    if ( *((_BYTE *)v2 + 250 * j + 10203) == 5 )
    {
      *((_BYTE *)v2 + 250 * j + 10393) = 81;
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 7, 1);
      hero::GiveSS((hero *)((char *)v2 + 250 * j + 10180), 12, 1);
    }
  }
  memset((char *)v2 + 10099, 0xFFu, 0x48u);
  for ( n = 0; n < 72; ++n )
  {
  ...
  for ( jj = 0; jj < 144; ++jj )
    memset((char *)v2 + 7 * jj + 23734, 0xFFu, 7u);
  memset((char *)v2 + 24742, 0xFFu, 0x90u);
  for ( kk = 0; kk < 48; ++kk )
  {
