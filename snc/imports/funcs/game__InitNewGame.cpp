{
  ...
  v12 = 0;
  v4 = 0;
  if ( *(_BYTE *)(this + 1146) && *(_BYTE *)(this + 1147) == iLastMsgNumHumanPlayers )
  {
    for ( i = 0; *(_BYTE *)(this + 707) > i; ++i )
    {
      if ( *(_BYTE *)(i + this + 1119) == 10 || *(_BYTE *)(i + this + 1119) >= iLastMsgNumHumanPlayers )
  ...
  else
  {
    *(_BYTE *)(this + 1147) = iLastMsgNumHumanPlayers;
    if ( a2 )
      ...
      GetMapHeader(this + 1126, (void *)(this + 681));
    for ( j = 0; j < 6; ++j )
    {
      if ( *(_BYTE *)(j + v3 + 689) )
        *(_BYTE *)(v5++ + v3 + 1101) = j;
    ...
    v13 = v12 < iLastMsgNumHumanPlayers && *(_BYTE *)(v3 + 707) - iLastMsgNumHumanPlayers > v4;
    ...
    for ( n = 0; *(_BYTE *)(v3 + 707) > n; ++n )
    {
      ...
      {
        if ( v12 < iLastMsgNumHumanPlayers && *(_BYTE *)(*(_BYTE *)(n + v3 + 1101) + v3 + 695) )
          *(_BYTE *)(n + v3 + 1119) = v12++;
        else
          *(_BYTE *)(n + v3 + 1119) = 10;
      }
