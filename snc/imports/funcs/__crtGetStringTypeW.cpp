{
  ...
  {
    v6 = GetStringTypeW;
    if ( GetStringTypeW(1u, &_string_, 1, CharType) )
    {
      dword_522360 = 1;
    }
    else
    {
      if ( !GetStringTypeA(0, 1u, _string_, 1, CharType) )
        return;
      dword_522360 = 2;
    }
  }
  ...
  else if ( dword_522360 == 2 )
  {
    ...
    *(_DWORD *)CharType = 0;
    ...
    if ( v9 )
    {
      v11 = (const CHAR *)calloc(1, v9);
      if ( v11 )
      {
        if ( WideCharToMultiByte(v8, 0x220u, lpWideCharStr, cchWideChar, (LPSTR)v11, v10, 0, 0) )
        {
          v7 = (WORD *)malloc(2 * v10 + 2);
          if ( v7 )
          {
            v12 = Locale;
            if ( !Locale )
              v12 = ::Locale;
            v13 = (int)&v7[cchWideChar];
            *(_WORD *)v13 = -1;
            *(_WORD *)(v13 - 2) = -1;
            v14 = GetStringTypeA(v12, dwInfoType, v11, v10, v7);
            v16 = *(_WORD *)(v13 - 2) == -1;
            *(_DWORD *)CharType = v14;
            if ( v16 || *(_WORD *)v13 != -1 )
              *(_DWORD *)CharType = 0;
            else
              memmove(lpCharType, v15, lpCharType, v7, 2 * cchWideChar);
          }
        }
        free((BOOL)v11);
        free((BOOL)v7);
