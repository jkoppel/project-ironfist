{
  ...
  else
  {
    ...
    if ( !((unsigned __int8)giCurPlayerBit & mapExtra[v13]) )
      return v13;
    ...
    if ( (unsigned __int16)word_526C5A <= v16 || v16 <= 0 )
    {
          ...
          *(_DWORD *)dword_526CAC = (unsigned __int8)byte_526C59;
          ...
          if ( dword_526C90 == 42 )
          {
            if ( gpGame->relatedToHeroForHireStatus[advManager::GetCell(
                                                      ...
                                                      (unsigned __int8)byte_526C59)->flags >> 3] == giCurPlayer )
              goto LABEL_72;
          }
        }
        else
      ...
      else
      {
        ...
        if ( a7 && !(byte_526C5C & 4) )
        {
          ...
          if ( advManager::FindAdjacentMonster(gpAdvManager, v22, (int)dword_526C94, (int)dword_526CAC, -1, -1) )
            dword_526C2C = 1;
LABEL_55:
          HIDWORD(v23) = (unsigned __int8)byte_526C59;
          LODWORD(v23) = (unsigned __int8)byte_526C58;
          searchArray::TestPossibleDirections(thisa, v23, (int)byte_526C30, (int)byte_526C78, 1, a6);
          dword_526CB0 = (unsigned __int8)giGroundToTerrain[advManager::GetCell(
                                                              gpAdvManager,
                                                              (unsigned __int8)byte_526C58,
                                                              (unsigned __int8)byte_526C59)->tileType];
          v24 = (unsigned __int8)(advManager::GetCell(
                                    gpAdvManager,
                                    (unsigned __int8)byte_526C58,
          ...
          do
          {
            if ( byte_526C30[dword_526C9C] != -1 )
            {
              ...
              v26 = dword_526C38 + dword_526C6C * MAP_WIDTH;
                ...
                || *(_BYTE *)(dword_526CA4 + 6) != *(_DWORD *)dword_526CAC )
              {
                ...
                v35 = advManager::GetCell(gpAdvManager, dword_526C38, dword_526C6C);
                v36 = CalcTerrainCost(
                        dword_526CB0,
                        dword_526C9C,
                        dword_526C3C,
                ...
                if ( dword_526C28 )
                {
                  if ( __PAIR__(dword_526C6C, dword_526C38) == a10 )
                  {
                    ...
                    {
                      v37 = dword_526C44;
                      v38 = advManager::GetCell(gpAdvManager, dword_526C38, dword_526C6C);
          ...
          if ( (advManager::GetCell(gpAdvManager, dword_526C8C, dword_526C64)->objType & 0x7F) == 24 )
          {
            ...
            do
            {
              ...
              if ( dword_526C50 >= 0 && dword_526C50 < MAP_WIDTH && dword_526C88 >= 0 && MAP_HEIGHT > dword_526C88 )
              {
                ...
                if ( dword_526C68 )
                {
                  v41 = dword_526C50 + dword_526C88 * MAP_WIDTH;
                  if ( thisa->field_2414[v41].field_4 & 1 )
                  {
                    if ( !(*(_BYTE *)(dword_526C84 + 9) & 0x80) )
                    {
                      v42 = (unsigned __int8)giGroundToTerrain[*(_WORD *)dword_526C84];
                      HIWORD(v43) = 0;
                      dword_526CB0 = v42;
