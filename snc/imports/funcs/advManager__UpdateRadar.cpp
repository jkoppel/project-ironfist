          ...
          else
          {
            ...
            if ( v8 != 62 || *(_BYTE *)(v13 + 9) != 103 )
            {
              switch ( v8 )
              {
                case 35:
                case 36:
                  v10 = gpGame->_7[(unsigned __int8)((unsigned __int8)(*(_WORD *)(v13 + 4) >> 8) >> -5)];
                  v21 = gpGame->castles[(unsigned __int8)((unsigned __int8)(*(_WORD *)(v13 + 4) >> 8) >> -5)].field_4;
                  v16 = gpGame->castles[(unsigned __int8)((unsigned __int8)(*(_WORD *)(v13 + 4) >> 8) >> -5)].field_5;
                  if ( v10 < 0 )
                    v6 = 6;
                  else
                ...
                case 49:
                  switch ( *(_BYTE *)(v13 + 9) )
                  {
                    ...
                    case 0x97:
                    case 0x9D:
                      v11 = gpGame->_8[(unsigned __int8)((unsigned __int8)(*(_WORD *)(v13 + 4) >> 8) >> -5) + 1008];
                      if ( v11 < 0 )
                        v5 = 6;
                      else
...
LABEL_88:
                  switch ( *(_BYTE *)(v13 + 9) )
                  {
                    ...
                    case 0x97:
                    case 0x9D:
                      v12 = gpGame->_8[(unsigned __int8)((unsigned __int8)(*(_WORD *)(v13 + 4) >> 8) >> -5) + 1008];
                      if ( v12 < 0 )
                        v4 = 6;
                      else
