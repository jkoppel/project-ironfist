{
  ...
  {
    v13 = (int *)((char *)__pioinfo + ((a1 & 0xFFFFFFE7) >> 3));
    v5 = *(int *)((char *)__pioinfo + ((a1 & 0xFFFFFFE7) >> 3));
    v14 = 36 * (a1 & 0x1F);
    ...
    if ( *(_BYTE *)(v6 + 4) & 0x80 )
    {
      v11 = 0;
      v7 = lpBuffer;
      while ( (_BYTE *)v7 - (_BYTE *)lpBuffer < nNumberOfBytesToWrite )
      {
        v8 = &Buffer;
        do
        {
          if ( (_BYTE *)v7 - (_BYTE *)lpBuffer >= nNumberOfBytesToWrite )
            break;
          v9 = *(_BYTE *)v7++;
          if ( v9 == 10 )
          {
    ...
    else if ( WriteFile(*(HANDLE *)v6, lpBuffer, nNumberOfBytesToWrite, &NumberOfBytesWritten, 0) )
    {
      v11 = 0;
      v15 = NumberOfBytesWritten;
    }
...
LABEL_18:
    ...
    else if ( *(_BYTE *)(*v13 + v14 + 4) & 0x40 && *(_BYTE *)lpBuffer == 26 )
    {
      result = 0;
    }
    else
