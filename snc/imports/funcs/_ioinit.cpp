{
  ...
  v0 = (unsigned int)malloc(0x480u);
  if ( !v0 )
    _amsg_exit(27);
  __pioinfo[0] = v0;
  for ( _nhandle = 32; __pioinfo[0] + 1152 > v0; *(_DWORD *)(v0 - 28) = 0 )
  {
    *(_BYTE *)(v0 + 4) = 0;
    v0 += 36;
    *(_DWORD *)(v0 - 36) = -1;
  ...
  if ( StartupInfo.cbReserved2 && StartupInfo.lpReserved2 )
  {
    ...
    if ( *(_DWORD *)StartupInfo.lpReserved2 >= 2048 )
      v1 = 2048;
    if ( v1 > (signed int)_nhandle )
    {
      v4 = &unk_538E24;
      while ( 1 )
      {
        v5 = (unsigned int)malloc(0x480u);
        if ( !v5 )
          break;
        *(_DWORD *)v4 = v5;
        _nhandle += 32;
...
LABEL_17:
    for ( i = 0; v1 > i; ++v3 )
    {
      ...
      {
        v7 = *(int *)((char *)__pioinfo + ((i & 0xFFFFFFE7) >> 3)) + 36 * (i & 0x1F);
        *(_DWORD *)v7 = *v3;
        *(_BYTE *)(v7 + 4) = *v2;
      }
      ++i;
  ...
  while ( v8 < 108 );
  return SetHandleCount(_nhandle);
}