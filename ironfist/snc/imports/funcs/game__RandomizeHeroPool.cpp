{
  ...
  for ( i = 0; i < 54; ++i )
  {
    *(_DWORD *)((char *)v1 + 250 * i + 10237) = Random(0, 50) + 40;
    game::SetRandomHeroArmies(v1, i, 0);
    *(_DWORD *)((char *)v1 + 250 * i + 10233) = hero::CalcMobility((hero *)((char *)v1 + 250 * i + 10180));
    *(_DWORD *)((char *)v1 + 250 * i + 10229) = *(_DWORD *)((char *)v1 + 250 * i + 10233);
    *((_BYTE *)v1 + 250 * i + 10279) = Random(1, 255);
