{
  ...
  if ( (signed int)a2 > 0 && SHIDWORD(a2) > 0 && MAP_WIDTH - 1 > (signed int)a2 && MAP_HEIGHT - 1 > SHIDWORD(a2) )
  {
    for ( dword_524CF0 = a2 - 1; dword_524CFC > dword_524CF0; ++dword_524CF0 )
    {
      for ( dword_524D0C = HIDWORD(a2) - 1; dword_524D0C < dword_524CE0; ++dword_524D0C )
      {
                      ...
                      + 9) == 152 )
        {
          ...
          else if ( (HIBYTE(advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_2) == 255
   || ((LOBYTE(advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_2) >> 2) & 0x3F) == 47
   || advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_8 & 0x80)
  ...
  if ( MAP_WIDTH - 1 == (_DWORD)a2 )
    dword_524CFC = a2 + 1;
  if ( MAP_HEIGHT - 1 == HIDWORD(a2) )
...
LABEL_50:
  ...
  if ( HIBYTE(advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_2) != 255
    && ((LOBYTE(advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_2) >> 2) & 0x3F) != 47
    && !(advManager::GetCell((advManager *)thisa, a2, SHIDWORD(a2))->field_8 & 0x80)
    || dword_524CF0 == a5 && dword_524D0C == a6 )
    goto LABEL_50;
