{
  ...
  if ( result == 1 )
  {
    ...
    if ( !v8 )
      return 0;
    v9 = (WCHAR *)malloc(2 * v8);
    if ( !v9 )
      return 0;
    if ( !GetLocaleInfoW(Locale, LCType, v9, v8) )
      goto LABEL_20;
    if ( cchMultiByte )
    {
      v10 = WideCharToMultiByte(v7, 0x220u, v9, -1, lpMultiByteStr, cchMultiByte, 0, 0);
      if ( !v10 )
        goto LABEL_20;
    }
    else
    {
      v10 = WideCharToMultiByte(v7, 0x220u, v9, -1, 0, 0, 0, 0);
      if ( !v10 )
      {
LABEL_20:
        free((BOOL)v9);
