{
  ...
  for ( j = 0; j < 4; ++j )
  {
    ...
    if ( v14 != -1 )
    {
      ...
      if ( v6 >= 0 )
      {
        v15[j] = (int)(&gpGame->map.tiles[v6 * gpGame->map.width] + HIDWORD(v6));
        if ( j <= 1 )
        {
          if ( *(_BYTE *)(v15[j] + 3) != 255 )
          {
            ...
            if ( *(_WORD *)(v15[j] + 10)
              && *(_BYTE *)(7 * *(_WORD *)(v15[j] + 10) + *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) + 3) != 255 )
              v17[j] = *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) + 7 * *(_WORD *)(v15[j] + 10);
            else
              v17[j] = 0;
            while ( v17[j] )
            {
              ...
              if ( *(_WORD *)v17[j]
                && *(_BYTE *)(7 * *(_WORD *)v17[j] + *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) + 3) != 255 )
                v17[j] = *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) + 7 * *(_WORD *)v17[j];
              else
                v17[j] = 0;
            }
          }
  ...
  *(_BYTE *)(a2 + 2) &= 0xFEu;
  for ( k = 0; k < 5; ++k )
  {
    ...
    if ( v12 )
    {
      if ( ((*(_BYTE *)(v12 + 2) >> 2) & 0x3F) == 47 )
      {
        if ( *(_WORD *)(v12 + 10) )
        {
          if ( *(_BYTE *)(*(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4)
                        - *(_WORD *)(v12 + 10)
                        + 8 * *(_WORD *)(v12 + 10)
                        + 3) != 255 )
          {
            v16 = *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) - *(_WORD *)(v12 + 10) + 8 * *(_WORD *)(v12 + 10);
  ...
  for ( l = 0; l < 5; ++l )
  {
    ...
    {
      if ( *(_WORD *)(v13 + 10)
        && *(_BYTE *)(*(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) - *(_WORD *)(v13 + 10) + 8 * *(_WORD *)(v13 + 10) + 3) != 255 )
        v16 = *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) - *(_WORD *)(v13 + 10) + 8 * *(_WORD *)(v13 + 10);
      else
        v16 = 0;
      while ( v16 )
      {
        if ( ((*(_BYTE *)(v16 + 2) >> 1) & 0x7F) != 47
          ...
          goto LABEL_88;
        if ( *(_WORD *)v16
          && *(_BYTE *)(*(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) - *(_WORD *)v16 + 8 * *(_WORD *)v16 + 3) != 255 )
          v16 = *(_DWORD *)(*(_DWORD *)&this[14].field_6 + 4) - *(_WORD *)v16 + 8 * *(_WORD *)v16;
        else
          v16 = 0;
      }
      *(_BYTE *)(v13 + 8) |= 0x80u;
...
LABEL_88:
  ...
  advManager::SetEnvironmentOrigin(
    (advManager *)this,
    *(_DWORD *)&this[39].field_2 + 7,
    *(_DWORD *)&this[39].field_6 + 7,
    1);
  return game::SetupAdjacentMons();
}