{
  ...
  v51 = 25;
  v54 = 0;
  soundManager::SwitchAmbientMusic(gpSoundManager, 23);
  ...
  for ( spriteIdx = 0; spriteIdx < 48; ++spriteIdx )
    icon::DrawToBuffer(v56, 0, 0, spriteIdx, 0);
  ...
  v62 = 0;
  v61 = 0;
  v62 = (gpGame->_10[25] + gpGame->_10[24]) % 3 - 1;
  v61 = (5 * gpGame->_10[25] + 2 * gpGame->_10[24]) % 3 - 1;
  if ( (gpGame->_10[25] + gpGame->_10[24]) % 3 == 1 )
  {
    if ( v62 <= 0 )
    {
      if ( v62 < 0 )
  ...
  {
    v1 = (signed int)gpGame->_10[25] + (signed int)gpGame->_10[24];
  ...
  v57 += v62;
  v55 += v61;
  advManager::PuzzleDraw(this, v57, v55, gpGame->_10[24], gpGame->_10[25]);
  for ( i = 16; i < 464; ++i )
  {
    v59 = (unsigned int)&gpWindowManager->screenBuffer->contents[640 * i + 16];
    v60 = v59 + 448;
    while ( v59 < v60 )
    {
  ...
  for ( spriteIdx = 0; spriteIdx < 48; ++spriteIdx )
  {
    if ( !BitTest((char *)&puzzlePiecesRemoved, spriteIdx) )
    {
      icon::DrawToBuffer(v56, 0, 0, (unsigned __int8)*(&v4 + spriteIdx), 0);
      ++v54;
    }
  }
  if ( v54 == 48 )
