{
  ...
  if ( *(_BYTE *)(this + 715) )
  {
    ...
    {
      case 1:
        v3 = game::GetTownId((void *)this, *(_WORD *)(this + 716), *(_WORD *)(this + 727));
        result = sprintf(
                   a2,
                   "Lose the %s '%s'.",
      ...
      case 3:
        result = sprintf(
                   ...
                   (*(_WORD *)&gpGame->_2[1] - 1) / 28 + 1,
                   (*(_WORD *)&gpGame->_2[1] - 28 * ((*(_WORD *)&gpGame->_2[1] - 1) / 28) - 1) / 7 + 1,
                   (*(_WORD *)&gpGame->_2[1] - 1) % 7 + 1);
        break;
    }
  }
  else
