{
  ...
  unsigned int v24; // [sp+1Ch] [bp-4h]@17
  ...
  if ( !nNumberOfBytesToRead )
    return 0;
  v5 = (char *)__pioinfo + ((a1 & 0xFFFFFFE7) >> 3);
  v6 = 36 * (a1 & 0x1F);
  v7 = v6 + *(_DWORD *)v5;
  if ( *(_BYTE *)(v7 + 4) & 2 )
    return 0;
  ...
  if ( !ReadFile(*(HANDLE *)(*(_DWORD *)v5 + v6), (LPVOID)v3, v4, &NumberOfBytesRead, 0) )
  {
    v10 = GetLastError();
    if ( v10 == 5 )
    {
