{
  ...
  *(_DWORD *)a4 = 0;
  ...
  && !giGroundToTerrain[advManager::GetCell(gpAdvManager, *(_BYTE *)(a2 + 4) - 1, *(_BYTE *)(a2 + 5) + 1)->tileType]
  && !dword_532CE8
      ...
      for ( j = 0; *(_BYTE *)(i + a2 + 79) > j; ++j )
      {
        if ( !hero::HasSpell((hero *)a1, (Spell)*(_BYTE *)(j + 4 * i - 4 + a2 + 60)) )
        {
          if ( gsSpellInfo[*(_BYTE *)(j + 4 * i - 4 + a2 + 60)].attributes & 1 )
            ...
            v10 = 1;
          *(_DWORD *)a4 += v10 * *(_WORD *)&gsSpellInfo[*(_BYTE *)(j + 4 * i - 4 + a2 + 60)].appearingChance;
        }
      }
    }
  }
  ...
  if ( gpGame->winConditionType == 1
    && gpGame->winConditionArgument == *(_BYTE *)(a2 + 4)
    && *(_WORD *)&gpGame->field_2D5 == *(_BYTE *)(a2 + 5) )
    v19 = 0.80000001;
  if ( v19 < (double)v15 )
    v9 = v15 - v19;
  else
  ...
  if ( v19 * 0.15 <= v9 && v9 >= 0.08 )
  {
    ...
    if ( a3 )
    {
      ...
      v7 = v9 + 1.0 - 0.22;
      v8 = v7;
      v13 = (signed __int64)((v7 * v8 - 1.0) * *(float *)&gpCurPlayer->_4[100] * (double)(v32 + v28) * v12);
      if ( v13 < 0 )
        v13 = 0;
      v11 = 0;
      if ( v29 )
