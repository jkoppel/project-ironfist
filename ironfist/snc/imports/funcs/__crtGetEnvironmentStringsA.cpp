{
  ...
  if ( dword_52157C == 1 )
  {
    if ( v0 || (v0 = GetEnvironmentStringsW()) != 0 )
    {
      ...
      v6 = v5;
      if ( v5 && (v7 = (CHAR *)malloc(v5), (v8 = (BOOL)v7) != 0) )
      {
        if ( !WideCharToMultiByte(0, 0, v0, v4, v7, v6, 0, 0) )
        {
          free(v8);
          v8 = 0;
        }
  ...
  else if ( dword_52157C == 2 )
  {
    if ( v1 || (v1 = GetEnvironmentStringsA()) != 0 )
    {
      for ( j = v1; *j; ++j )
      {
        do
