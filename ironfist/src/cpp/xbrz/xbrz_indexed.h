...
#ifndef XBRZ_INDEXED_HEADER_3847894708239054
#define XBRZ_INDEXED_HEADER_3847894708239054
...
namespace xbrz
	...
	*/
	...
	void scale(size_t factor, //valid range: 2 - 5
			   ...
			   int yFirst = 0, int yLast = 0x00ffffff); //slice of source image
	...
	void nearestNeighborScale(const uint8_t* src, int srcWidth, int srcHeight, int srcPitch, //pitch in bytes!
	...
	//########################### implementation ###########################
	inline
		void nearestNeighborScale(const uint8_t* src, int srcWidth, int srcHeight,
								  uint8_t* trg, int trgWidth, int trgHeight)
		{
		nearestNeighborScale(src, srcWidth, srcHeight, srcWidth * sizeof(uint8_t),
							 trg, trgWidth, trgHeight, trgWidth * sizeof(uint8_t),
